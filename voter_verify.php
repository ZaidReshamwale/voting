        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <br><marquee scrollamount="3" onMouseOut="start()" onMouseOver="stop()">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title style1"><strong style="color:#0033FF;">Verification</strong></h4>
                                <p class="category">&nbsp;</p>
                          </div>
...
?>
<form method="post" action="voter_verify_con.php">
<table width="351">
  <tr>
    <td height="44"><strong>ENTER VERIFICATION CODE:</strong></td>
    <td><label>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    <span class="style5">&copy; 2017 </span><span class="style5 style3 style4"><span class="style2"><strong></strong></span></span><span class="style5 style3"><span class="style1 style7 style3"><strong>Online Voting</strong></span></span><span class="style5"> <span class="style2">by CS,K.H.K.I.E, Dharwad, Karnataka, India.</span></span> </p>
          </div>
        </footer>
