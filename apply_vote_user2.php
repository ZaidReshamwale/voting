            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title style1"><strong style="color:#0033FF;">CANDIDATE DETAILS</strong></h4>
                                <p class="category">&nbsp;</p>
                          </div>
...
mysql_select_db("online_voting",$con);
$rh=mysql_query("select * from voter_info where election_id='$election_id'");
$rs=mysql_fetch_array($rh);

$wnum=$rs['ward_no'];


$sql="select * from candidate_info where ward_no='$ward' and constituency='$cons'";
$res=mysql_query($sql);
...
<table width="817" height="182" border="6">
  <?php
   ...
   $r=mysql_query("select * from candidate_info where constituency='$cons' ");
  ...
  <tr>
    <td colspan="3"><div align="right"><a href="apply_vote.php?aadhar_no=<?php echo $adhar;?>&pname=<?php echo $row['party_name'];?>&eid=<?php echo $election_id;?>&name=<?php echo $row['name'];?>&ward=<?php echo $ward;?>" class="style2">APPLY VOTE</a></div></td>
    </tr>
<?php
}
?>
...
<p><span class="style3"><a href="apply_vote3.php?status=<?php echo "Nota"?>&eeid=<?php echo"$election_id"?> style="color:#FF0000">CLICK HERE TO APPLY NOTA</a></span></p>
                          </div>
                      </div>
                    </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right"> <center>
                    &copy;ONLINE VOTING. ALL RIGHTS RESERVED. <br>
                    ONLINE VOTING SYSTEM BY CS DEPT, K.H.K.I.E, DHARWAD, KARNATAKA, INDIA.
                </p>
            </div>
        </footer>
